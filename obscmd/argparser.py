...
HELP_BLURB = (
    ...
    "  obscmd help\n"
    "  obscmd <command> help\n"
    "  obscmd <command> <subcommand> help\n"
)
USAGE = (
    "obscmd [options] <command> <subcommand> [<subcommand> ...] [parameters]\n"
    "%s" % HELP_BLURB
)
            ...
            if isinstance(value, str) and value.startswith('file://'):
                try:
                    ...
                    with open(filepath, 'r') as fp:
                        setattr(parsed, arg, fp.read())
                except:
                    raise argparse.ArgumentError(arg, '%s is not correct.')
