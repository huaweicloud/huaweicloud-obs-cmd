...
# from obscmd.utils import CachedProperty, instance_cache
# from obscmd.compat import OrderedDict
...
class Shape(object):
    ...
    def __init__(self, shape_name, shape_model, shape_resolver=None):
        ...
        :type shape_resolver: obscmd.model.ShapeResolver
...
class ServiceModel(object):
    ...
    def __init__(self, service_description, service_name=None):
        ...
        :param service_description: The service description model.  This value
            is obtained from a obscmd.loader.Loader, or from directly loading
            the file yourself::
        ...
        :param service_name: The name of the service.  Normally this is
            ...
            This is done in a few places in obscmd (ses instead of email,
...
class OperationModel(object):
    def __init__(self, operation_model, service_model, name=None):
        ...
        :type service_model: obscmd.model.ServiceModel
...
class DenormalizedStructureBuilder(object):
    ...
    Example usage::
        ...
        # ``shape`` is now an instance of obscmd.model.StructureShape
    ...
    def build_model(self):
        ...
        :rtype: obscmd.model.StructureShape
